...
def fragmentar_y_clasificar(imagen_path, clasificadores, scaler, distancias, angulos, propiedades, num_caracteristicas_esperadas, umbral_knn=0.8, umbral_svm=0.35):
